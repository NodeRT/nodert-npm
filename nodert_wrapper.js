...
function generateFromPackageJson(packageJsonPath, outputDir, cb) {
  if (packageJsonPath instanceof Function) {
    ...
    if (packageJsonPath && path.basename(packageJsonPath.toLowerCase()) != "package.json") {
  ...
  return cb("No NodeRT modules were specified in package.json");
}

exports.generateModules = generateModules;
exports.generateFromPackageJson = generateFromPackageJson;